...
class Locate {
  ...
  factory Locate.fromMap(Map<String, dynamic> map) {
    return Locate(
      ...
      geo_point: map['geo_point'] != null
          ? GeoPoint.fromMap(map['geo_point'] as Map<String, dynamic>)
          : null,
      geo_polygon: map['geo_polygon'] != null
          ? GeoPoint.fromMap(map['geo_polygon'] as Map<String, dynamic>)
          : null,
  ...
  factory Locate.fromJson(String source) =>
      Locate.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'Locate(id: $id, region: $region, country: $country, geo_point: $geo_point, geo_polygon: $geo_polygon, plant_id: $plant_id)';
  }
