              ...
              SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const DescriptionField(),SizedBox(
                      height: 15.h,
                    ),
                    Padding(
                      padding: EdgeInsets.symmetric(horizontal: 24.w),
    ...
    return Center(
      child: SizedBox(
        ...
        child: CupertinoTextField(
          ...
          placeholder:  notifier.country.isNotEmpty
              ? notifier.name_ru
              :  "Страна",
    ...
    return Center(
      child: SizedBox(
        ...
        child: CupertinoTextField(
          ...
          placeholder: notifier.region.isNotEmpty
              ? notifier.name_ru
              :  "Регион",
          placeholderStyle: TextStyle(
              color: Colors.grey.shade400,
    ...
    return Center(
      child: SizedBox(
        ...
        child: CupertinoTextField(
          ...
          placeholder:  notifier.descriptionRegion.isNotEmpty
              ? notifier.name_ru
    ...
    return Center(
      child: SizedBox(
        ...
        child: CupertinoTextField(
          ...
          placeholder: notifier.name_ru.isNotEmpty
              ? notifier.name_ru
    ...
    return Center(
      child: SizedBox(
        ...
        child: CupertinoTextField(
          ...
          placeholder: notifier.name_latin.isNotEmpty
              ? notifier.name_latin
    ...
    return Center(
      child: SizedBox(
        ...
        child: CupertinoTextField(
          ...
          placeholder:
              notifier.origin.isNotEmpty ? notifier.origin : "Происхождение",
          placeholderStyle: TextStyle(
              color: Colors.grey.shade400,
              fontFamily: 'Sora',
              fontWeight: FontWeight.w500,
    ...
    return Center(
      child: SizedBox(
        ...
        child: CupertinoTextField(
          ...
          placeholder: notifier.description.isNotEmpty
